          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr className="border-b border-gray-200 hover:bg-gray-50">
                ...
                <td className={`text-center py-3 px-4 font-bold text-lg ${scoreColor(bd.maScore)}`}>{scoreLabel(bd.maScore)}</td>
              ...
              <tr className="border-b border-gray-200 hover:bg-gray-50">
                ...
                <td className={`text-center py-3 px-4 font-bold text-lg ${scoreColor(bd.rsiScore)}`}>{scoreLabel(bd.rsiScore)}</td>
              ...
              <tr className="border-b border-gray-200 hover:bg-gray-50">
                ...
                <td className={`text-center py-3 px-4 font-bold text-lg ${scoreColor(bd.momentumScore)}`}>{scoreLabel(bd.momentumScore)}</td>
              ...
              <tr className="border-b border-gray-200 hover:bg-gray-50">
                ...
                <td className={`text-center py-3 px-4 font-bold text-lg ${scoreColor(bd.priceScore)}`}>{scoreLabel(bd.priceScore)}</td>
              ...
              <tr className="border-b border-gray-200 hover:bg-gray-50">
                ...
                <td className={`text-center py-3 px-4 font-bold text-lg ${scoreColor(bd.volatilityScore)}`}>{scoreLabel(bd.volatilityScore)}</td>
              ...
              <tr className="border-b border-gray-200 hover:bg-gray-50">
                ...
                <td className={`text-center py-3 px-4 font-bold text-lg ${scoreColor(bd.newsScore)}`}>{scoreLabel(bd.newsScore)}</td>
              ...
              <tr className="border-b-2 border-gray-300 hover:bg-gray-50">
                ...
                <td className={`text-center py-3 px-4 font-bold text-lg ${scoreColor(bd.coreMetricsScore)}`}>{scoreLabel(bd.coreMetricsScore)}</td>
                <td className="py-3 px-4 text-gray-700">{bd.coreMetricsReason}</td>
              </tr>
              <tr className="bg-blue-50 font-bold">
                <td className="py-4 px-4 text-gray-900">TOTAL SCORE</td>
                <td className={`text-center py-4 px-4 text-2xl ${scoreColor(bd.totalScore)}`}>
