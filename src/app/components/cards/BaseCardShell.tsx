...
export const BaseCardShell: React.FC<BaseCardShellProps> = ({ children, onClick, className = "" }) => {
  ...
  return (
    <div
      className={`w-full bg-white border border-gray-100 rounded-2xl shadow-md hover:shadow-lg transition-all duration-200 cursor-pointer flex flex-col h-full overflow-hidden ${className}`}
      style={{
