      ...
      <div className="flex flex-col sm:flex-row gap-6 items-center h-full">
        ...
        <div className="relative w-32 h-32 flex-shrink-0">
          ...
          <div className="absolute inset-4 bg-white rounded-full flex items-center justify-center flex-col">
            <span className={`text-lg font-extrabold leading-none ${netGain >= 0 ? 'text-green-600' : 'text-red-600'}`}>
        ...
        <div className="flex-grow w-full">
          <ul className="space-y-2">
            ...
            <li className="flex justify-between items-center text-sm border-t border-gray-100 pt-2 mt-2">
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-gray-300"></div>
                <span className="text-gray-500 font-medium">Cost Basis</span>
              </div>
              <span className="text-gray-900 font-bold">{formatCurrency(totals.costBasis, 0)}</span>
            </li>
          </ul>
        </div>
      </div>
