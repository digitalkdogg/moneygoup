  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`/api/user/stocks/${stock.stock_id}`, {
        ...
        body: JSON.stringify({ action: 'rsu_vest', shares: sharesNum, price: priceNum }),
      });
      if (!response.ok) {
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <div>
            <h2 id="modal-title" className="text-base font-bold text-gray-900">Record RSU Vest</h2>
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4" id="rsu-form">
            <div>
              <label htmlFor="vest-shares" className="block text-sm font-medium text-gray-700 mb-1">
                Shares Vested
              </label>
              <input
                id="vest-shares"
            ...
            <div>
              <label htmlFor="vest-price" className="block text-sm font-medium text-gray-700 mb-1">
            ...
            {newAvgPrice !== null && (
              <div className="bg-green-50 rounded-xl p-4 space-y-1.5" aria-live="polite">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">FMV of Vested Shares</span>
