...
const savePredictionSchema = z.object({
  ...
  predicted_price_3m: z.number().positive().optional(),
  ...
  predicted_change_pct_3m: z.number().optional(),
  ...
  confidence_score_3m: z.number().min(0).max(100).optional(),
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (payload.predicted_price_3m !== undefined) predictionData.predicted_price_3m = payload.predicted_price_3m;
    ...
    if (payload.predicted_change_pct_3m !== undefined) predictionData.predicted_change_pct_3m = payload.predicted_change_pct_3m;
    ...
    if (payload.confidence_score_3m !== undefined) predictionData.confidence_score_3m = payload.confidence_score_3m;
