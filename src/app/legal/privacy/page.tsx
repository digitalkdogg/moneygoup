      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-[0_1px_10px_rgba(0,0,0,0.1)] p-8 md:p-12">
          ...
          <div className="prose prose-gray max-w-none space-y-8 text-sm text-gray-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-semibold text-gray-900 mb-3">6. Cookies & Session Data</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-gray-900 mb-3">7. Your Rights & Choices</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-gray-900 mb-3">9. Children&rsquo;s Privacy</h2>
              <p>
