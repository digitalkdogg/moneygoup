      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-[0_1px_10px_rgba(0,0,0,0.1)] p-8 md:p-12">
          ...
          <div className="space-y-8 text-sm text-gray-700 leading-relaxed">
            ...
            <section className="section-1-not-financial-advice">
            ...
            <section className="section-2-ai-predictions-gps-scores">
            ...
            <section className="section-3-past-performance">
            ...
            <section className="section-4-market-data-accuracy">
            ...
            <section className="section-5-investment-risk">
            ...
            <section className="section-6-no-responsibility-for-losses">
            ...
            <section className="section-7-seek-professional-advice">
            ...
            <section className="section-8-third-party-references">
            ...
            <section className="section-9-regulatory-notice">
            ...
            <section className="section-10-questions">
