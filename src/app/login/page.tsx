...
function LoginForm() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center px-4 py-12">
      ...
      {/* Social proof bar */}
      <div className="w-full max-w-2xl mt-8 bg-white rounded-xl shadow-sm border border-gray-100 px-6 py-4 grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
        {STATS.map((s) => (
          <div key={s.label}>
      ...
      {/* Register CTA */}
      <div className="w-full max-w-4xl mt-6 bg-white rounded-2xl shadow-sm border border-gray-100 px-8 py-7 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>
