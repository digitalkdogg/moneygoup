...
const PUBLIC_PATHS = ['/', '/login', '/register', '/forgot-password', '/reset-password', '/api/unsubscribe', '/contact', '/api/contact', '/legal/privacy', '/legal/terms', '/legal/disclaimer', '/opengraph-image', '/login/opengraph-image', '/register/opengraph-image', '/sitemap.xml', '/robots.txt', '/api/analytics/model-accuracy'];
