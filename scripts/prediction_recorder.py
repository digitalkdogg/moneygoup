...
def record_prediction(
    ...
    at_model_ceiling_3m: bool | None = None,
    ...
    confidence_reason_3m: str | None = None,
    ...
    try:
        ...
        cursor.execute(query, (
            ...
            data_quality_json,
            model_status,
            None if at_model_ceiling_3m is None else (1 if at_model_ceiling_3m else 0),
